// VaultIQ Injected Script - Runs in main world (page context)
// This script creates the Ethereum provider that DApps can access
...
(function() {
  ...
  class VaultIQProvider {
    ...
    sendToExtension(message) {
      return new Promise((resolve) => {
        ...
        // Send to content script which will forward to background
        window.postMessage({
  ...
  if (!window.ethereum) {
    ...
    // Also dispatch the standard EIP-6963 event for wallet discovery
    window.dispatchEvent(new CustomEvent('eip6963:announceProvider', {
      detail: {
        info: {
          uuid: 'vaultiq-wallet',
          name: 'VaultIQ',
          icon: 'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMzIiIGhlaWdodD0iMzIiIHZpZXdCb3g9IjAgMCAzMiAzMiIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPHJlY3Qgd2lkdGg9IjMyIiBoZWlnaHQ9IjMyIiByeD0iOCIgZmlsbD0iIzAwN0FGRiIvPgo8L3N2Zz4K',
  ...
  console.log('VaultIQ provider injected into main world')
})();
